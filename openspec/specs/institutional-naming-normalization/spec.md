# institutional-naming-normalization Specification

## Purpose
Define normalization rules ensuring migrated public content uses APU Semarang naming while preserving legal/historical provenance where required.
