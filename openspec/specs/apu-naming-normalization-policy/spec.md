# apu-naming-normalization-policy Specification

## Purpose
Define public-facing institutional naming policy for detailed page blueprints, including controlled legal/history exceptions and QA enforcement.
